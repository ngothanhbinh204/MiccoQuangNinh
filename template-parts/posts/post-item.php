...
<div class="news-item h-full group">
    <div class="img zoom-in overflow-hidden">
        <a class="img-ratio ratio:pt-[248_440]" href="<?php echo $url; ?>">
    ...
    <div class="txt p-4 lg:pt-4 lg:pb-6">
        ...
        <h3 class="mb-2 pb-2 border-b border-grey-100">
            <a class="uppercase flex-start font-bold title transition  group-hover:text-primary-1" href="<?php echo $url; ?>"><?php the_title(); ?></a>
        </h3>
