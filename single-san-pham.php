                            ...
                            <?php if ($gallery && is_array($gallery)): ?>
                                ...
                                ?>
                                    <div class="swiper-slide">
                                        <a class="img img-ratio ratio:pt-[600_1400] -lg:ratio:pt-[70%] zoom-img rounded-4" 
                                           href="<?php echo esc_url($image_url); ?>" 
                                           data-fancybox="gallery">
                                            <?php if (is_array($image)): ?>
                                                <img class="lozad" data-src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt'] ?: get_the_title()); ?>" />
                                            <?php else: ?>
