        ...
        <div class="row"> 
            <div class="col w-full lg:w-1/2">
                <div class="txt-wrap lg:pr-18 ">
                    ...
                    <h2 class="heading-1-up pt-8 mb-6 lg:pt-12 max-lg:text-center"><?php echo $title ? $title : __('Tuyển dụng', 'canhcamtheme'); ?></h2>
                    <?php if($description): ?>
...
<?php if(get_field('block_content_tuyen_dung','option')): ?>
    <?php
    $block_content = get_field('block_content_tuyen_dung','option');
    ?>
...
<?php if(get_field('training_tuyen_dung','option')): ?>
    <?php 
                            ...
                            <div class="swiper-slide">
                                <div class="item overflow-hidden bg-grey-50">
                                    ...
                                    <div class="txt p-6 text-center lg:py-10">
                                        ...
                                        <div class="desc my-6"><?php echo $item['description']; ?></div>
                                        <div class="btn-wrap flex-center"><a class="btn btn-tertiary"><span><?php _e('Xem thêm', 'canhcamtheme'); ?></span><em class="fa-light fa-chevron-right"></em></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php if(get_field('career_list','option')): ?>
    <?php
    $recruit_list = get_field('career_list','option');
    ...
    <div class="container">
        ...
        <div class="filter-table-wrap">
            ...
            <div class="ajax-btn-wrap mx-auto w-fit pt-9" id="load-more-container">
                <a class="btn btn-primary down btn-load-more" id="load-more-btn"><span><?php _e('Xem thêm', 'canhcamtheme'); ?></span><em class="fa-regular fa-chevron-down"></em></a>
            </div>
            <?php endif; ?>
